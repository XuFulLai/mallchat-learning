...
import com.xiaxia.mallchat.common.common.handler.GlobalUncaughtExceptionHandler;
import com.xiaxia.mallchat.common.user.dao.UserDao;
import com.xiaxia.mallchat.common.user.domain.dto.IpResult;
import com.xiaxia.mallchat.common.user.domain.entity.IpDetail;
import com.xiaxia.mallchat.common.user.domain.entity.IpInfo;
import com.xiaxia.mallchat.common.user.domain.entity.User;
import com.xiaxia.mallchat.common.user.service.IpService;
...
//                userCache.userInfoChange(uid);
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 100; i++) {
            int finalI = i;
            EXECUTOR.execute(() -> {
                IpDetail ipDetail = TryGetIpDetailOrNullTreeTimes("117.43.64.67");
                System.out.println(ipDetail.getIp() + " " + ipDetail.getCountry() + " " + ipDetail.getRegion() + " " + ipDetail.getCity() + " " + ipDetail.getIsp());
                if (Objects.nonNull(ipDetail)) {
                    Date date = new Date();
